...
Description
    waveFoam compiled under an explicit dynamic-mesh name: v2306 interFoam
    already carries the full moving-mesh machinery (mesh.update, gh/ghf with
    waves2Foam referencePoint, correctPhi), so this build differs from
    waveFoam only in name -- used for morphing-mesh coupled cases.
